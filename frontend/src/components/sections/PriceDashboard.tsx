...
interface DashboardProps { location?: string; }
export function PriceDashboard({ location }: DashboardProps) {
      ...
      <div className="container px-4">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-4 px-4 py-2 rounded-full bg-card border border-border text-sm">
            ...
            {location && (
              <div className="flex items-center gap-1.5 text-xs bg-primary/10 text-primary border border-primary/20 rounded-full px-3 py-1">
                <span>📍</span>
